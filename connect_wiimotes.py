...
def create_config_file(player):
	template_file = open('/home/pi/wminput/gamepad')
	content = template_file.read()
	template_file.close()

	new_file = open('/home/pi/wminput/custom_gamepad' + player, 'w')
...
def connect_wiimotes():
	...
	process = subprocess.Popen(['wminput', '-c', '/home/pi/wminput/custom_gamepad' + str(player)],
